...
const ConnectWalletButton = () => {
  ...
  return (
    <button
      ...
      type='button'
      className="flex items-center justify-center text-center gap-2 bg-blue-600 hover:bg-blue-700 transition-colors px-5 py-1 rounded-lg text-white  cursor-pointer mr-3"
    >
      <Wallet size={15} />
      {isConnecting ? (
