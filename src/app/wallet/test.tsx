...
//       const timestamp = Number(lastDistribution); // Convert BigNumber to number
...
//                   <div className="flex items-end gap-2">
//                     <p className="text-4xl font-bold">{userRewards.toFixed(4)}</p>
//                     <p className="text-xl text-gray-400 mb-1">HYPE</p>
//                   </div>
//                 </div>
...
//                     <p className="font-medium">Time Of Distribution</p>
